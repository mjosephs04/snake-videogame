...
public:
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    void printFontNumber(string fileName, int xBaseLocation, int yBaseLocation,
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    void printFontLetter(string fileName, int xBaseLocation, int yBaseLocation,
                         SDL_Plotter& g, int thickness, int, int, int);
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    void printScoreSingle(int, font&, SDL_Plotter&,
                          int, int, int = 3);
    ...
    * postcondition: printed score on the screen when it is a double digit   *
    *                number                                                  *
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    void printScoreDouble(int, font&, SDL_Plotter&,
    ...
    * postcondition: printed score on the screen when it is a tripe digit    *
    *                number                                                  *
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    void printScoreTriple(int, font&, SDL_Plotter&,
